...
namespace AEX::NetProto {
    struct arp_ongoing_query {
        Net::ipv4_addr address;
        NetDevice_SP   net_dev;
    };
    ...
    void ARPLayer::parse(Dev::NetDevice_SP net_dev, void* packet_ptr, size_t len) {
    ...
    arp_promise ARPLayer::arpQuery(Net::ipv4_addr address) {}
}