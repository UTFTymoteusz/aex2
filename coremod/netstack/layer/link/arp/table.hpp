...
namespace NetStack {
    class ARPTable {
        ...
        static AEX::Mem::Vector<arp_entry, 16, 16> _entries;
        static AEX::Spinlock                       _entries_lock;
        static AEX::Mem::Vector<arp_query, 8, 8>   _queries;
        static AEX::Spinlock                       _queries_lock;
